# Plan Détaillé du Cahier des Charges - AGEN-OHADA
...
- **Frontend / Backend (Full-Stack) :** RIO (Python Framework) - pour une unification du développement et une robustesse Python.
